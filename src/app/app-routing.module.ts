    ...
    RouterModule.forChild([
      {
        ...
        children: [
          ...
          {
            path: "about/quan-ly-the-tap",
            component: AboutManagerComponent,
            canActivate: [AppRouteGuard],
          },
          {
            path: "about/gia-han",
            component: AboutGiahanComponent,
            canActivate: [AppRouteGuard],
          },
          {
            path: "about/gia-han/:idgoi",
            component: AboutListZumbaComponent,
            canActivate: [AppRouteGuard],
          },
          {
            path: "about/calendar",
            component: FullcalendartestComponent,
            canActivate: [AppRouteGuard],
          },
          {
            path: "about/gia-han/goi-zumba-yoga",
            component: AboutListZumbaComponent,
            canActivate: [AppRouteGuard],
          },
          {
            path: "about/gia-han/goi-tu-tap",
            component: AboutListTtComponent,
            canActivate: [AppRouteGuard],
          },
          {
            path: "about/gia-han/goi-doan-ket",
            component: AboutListDkComponent,
            canActivate: [AppRouteGuard],
          },
          {
            path: "about/gia-han/goi-pt",
            component: AboutListPtComponent,
            canActivate: [AppRouteGuard],
          },
        ],
      },
