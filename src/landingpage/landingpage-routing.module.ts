    ...
    RouterModule.forChild([
      {
        ...
        children: [
          ...
          { path: "coach/:namePt", component: InforHlvComponent },
          { path: "coach/hlv/sang-nguyen", component: InforHlv2Component },
          {
            path: "fitness/:idFitness",
            component: FitnessNewssHitthoComponent,
          },
          {
            path: "fitness/nhucau/:nameNhuCau",
            component: FitnessNewssExpComponent,
          },
          {
            path: "fitness/gym-bien-phap-ho-tro-giam-can",
            component: FitnessNewssGymSupportComponent,
          },
          {
            path: "fitness/bi-kip-tap-gym-dung-cach",
            component: FitnessNewssBiquyetComponent,
          },
          {
            path: "fitness/vi-sao-nen-tap-gym",
            component: FitnessNewssWhyGymComponent,
          },
          {
            path: "fitness/kinh-nghiem-cho-nu-moi",
            component: FitnessNewssExpComponent,
          },
          {
            path: "fitness/mot-so-bai-hieu-qua-nu-gioi",
            component: FitnessNewssHieuquaComponent,
          },
          {
            path: "fitness/kinh-nghiem-dong-luc-ben-bi",
            component: FitnessNewssKientriComponent,
          },
          {
            path: "fitness/than-hinh-dep",
            component: FitnessNewssDepComponent,
          },
